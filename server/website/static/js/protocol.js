//diplomacy protocol.js
//Jared Butcher 6/15/2018
//
...
const GAME = {
    ...
    PAUSE: '11' //By setting this field the game can be paused, value > 0 for timed pause, else paused until set to value < 0
}
const MAP = {
    DEFAULT: '0'
}
...
const DEFAULT_COUNTRIES = { //List of playable contries on default game board
    AUSTRIA: '0',
    ENGLAND: '1',
    FRANCE: '2',
    GERMANY: '3',
...
const DEFAULT_TERRITORIES = { //List of territories on default game board
...
export {FIELD, ACTION, ERROR, GAME, MAP, PLAYER, USER, PHASE, UNIT, UNIT_TYPE, ORDER, CHAT, DEFAULT_COUNTRIES, DEFAULT_TERRITORIES};